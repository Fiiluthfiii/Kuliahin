...
async function main() {
  ...
  const schedules = [
    // Senin
    {
      courseIndex: 0, // Pemrograman Web Lanjut
      dayOfWeek: 'Senin',
      startHour: 8,
      startMinute: 0,
      endHour: 10,
      endMinute: 30,
      room: 'Lab Komputer Terpadu 3',
    },
    {
      courseIndex: 3, // Sistem Terdistribusi
      dayOfWeek: 'Senin',
      startHour: 13,
      startMinute: 0,
      endHour: 15,
      endMinute: 30,
      room: 'Ruang Teori 402 (Gedung B)',
    },
    // Selasa
    {
      courseIndex: 1, // Basis Data Lanjut
      dayOfWeek: 'Selasa',
      startHour: 8,
      startMinute: 0,
      endHour: 10,
    ...
    {
      courseIndex: 4, // Keamanan Siber
      dayOfWeek: 'Selasa',
      startHour: 13,
      startMinute: 0,
      endHour: 15,
      endMinute: 30,
      room: 'Lab Keamanan Jaringan',
    },
    // Rabu
    {
      courseIndex: 0, // Pemrograman Web Lanjut
    ...
    // Kamis
    {
      courseIndex: 2, // Kecerdasan Buatan
      dayOfWeek: 'Kamis',
      startHour: 8,
      startMinute: 0,
      endHour: 10,
      endMinute: 30,
      room: 'Lab AI & Machine Learning',
    },
    {
      courseIndex: 5, // Manajemen Proyek TI
      dayOfWeek: 'Kamis',
      startHour: 13,
      startMinute: 0,
      endHour: 15,
  ...
  const tasks = [
    {
      ...
      deadlineHours: 12, // 12 hours from now
      priority: 'high',
    },
    {
      courseIndex: 3,
  ...
  for (const taskData of tasks) {
    ...
    deadline.setHours(23, 59, 0, 0); // Set to end of day
